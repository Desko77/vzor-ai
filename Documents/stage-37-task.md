...
Полная компиляция (`./gradlew assembleDebug`) с `minSdk = 29` (уже исправлено) выявила 12 ошибок Kotlin. DAT SDK зависимости скачиваются успешно (mwdat-core:0.5.0, mwdat-camera:0.5.0), но код использует API неправильно.
